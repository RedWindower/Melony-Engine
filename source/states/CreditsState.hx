...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Melon Engine Team'],
			['RedWindows',		'windows',		'Main Programmer and Head of Melon Engine',					 'https://youtube.com/@TheRedWindower',		'FF2D00'],
			['LatrellTheWatermelon',				'trell',			'The Person I Made Melon Engine For',						 'https://youtube.com/@TheMostMoldyMelon',		'09FF00'],
			[''],
			['Psych Engine Team'],
